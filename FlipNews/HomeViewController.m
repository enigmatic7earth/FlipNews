...
-(void) initGAdBanner
{
    ...
    request.testDevices = @[kGADSimulatorID,@"cfe9d4ff4b613d5bae6c29b5e2d7b0ee",@"35e90ac9c91eb5a34b72770623666b05"];
    // cfe9d4ff4b613d5bae6c29b5e2d7b0ee -device ID of Netbiz iPad iOS 9.3, Arvind's iPhone
...
-(void) setUIAttributes
{
    ...
    _newsImageView.layer.borderColor = [appBlueColor CGColor];
