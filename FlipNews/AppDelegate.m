...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    pageControl.pageIndicatorTintColor = appBlueColor;
    ...
    {
        viewController = [storyboard instantiateViewControllerWithIdentifier:@"mySWRViewController"];
    }
    else
    {
...
-(void) initialNewsFetch //23-06-2017
{
    ...
    //2.Arts
    ArtsViewController * artsViewController = [[ArtsViewController alloc] init];
