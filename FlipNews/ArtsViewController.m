...
#import "ArtsContentViewController.h"


#define CONTENT_IDENTIFIER @"ArtsContentViewController"
...
- (void)viewDidLoad {
    ...
    [appSettings setValue:@"Arts" forKey:@"currentViewController"]; //31-May-2017_PS addition for checking which fetch method to call in Appdelegate
...
- (ArtsContentViewController *)contentViewWithIndex:(int)index
{
    ...
    ArtsContentViewController *page = [storyboard instantiateViewControllerWithIdentifier:CONTENT_IDENTIFIER];
